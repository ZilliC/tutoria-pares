    ...
    opciones: [
      {
        id: "a",
        texto:
          "mkdir proyecto — crea el directorio. Si ya existe, da un error. Con mkdir -p puedes crear directorios aninados sin error aunque existan.",
      },
  ...
  "HTTP/HTTPS": {
    ...
    opciones: [
      ...
      },
      {
        id: "b",
        texto:
          "HTTPS is la versión segura de HTTP porque cifra los datos que se transmiten.",
      },
      {
        id: "c",
        texto:
